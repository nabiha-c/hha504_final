...
| Storage Layer                         | **GCP Cloud Storage**                                  | Stores referral attachments (PDFs/images). The database stores the file path/URL instead of the file itself                | (Supports required “data layer” + realistic for documents)            |
